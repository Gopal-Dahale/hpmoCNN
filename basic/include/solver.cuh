...
public:
  ...
  void train(std::vector<float> &loss, std::vector<int> &val_acc,bool do);
  float step(int start_X, int start_y, std::vector<float> &fwd_vdnn_lag,
             std::vector<float> &bwd_vdnn_lag, int *correct_count, bool train,bool do);
  float step(int start_X, int start_y, int *correct_count, bool train,bool do);
  ...
  //   void getComputationTime(long num_epoch, std::vector<std::vector<float> >
  //   &fwd_computation_time,
  //                           std::vector<std::vector<float> >
  //                           &bwd_computation_time);
  //   void stepComputationTime(int start_X, int start_y, std::vector<float>
  //   &fwd_computation_time,
  //                            std::vector<float> &bwd_computation_time);

  //   void getTransferTime(long num_epoch, std::vector<std::vector<float> >
  //   &fwd_transfer_time,
  //                        std::vector<std::vector<float> >
  //                        &bwd_transfer_time);
  //   void stepTransferTime(int start_X, int start_y, std::vector<float>
  //   &fwd_transfer_time,
