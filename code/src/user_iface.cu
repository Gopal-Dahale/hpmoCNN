...
void ConvDescriptor::initializeValues(int input_channels, int output_channels, int kernel_h,
                                      int kernel_w, int input_h, int input_w, int pad_h, int pad_w,
                                      int stride_x, int stride_y, ActivationMode activation_mode,
                                      double actv_coef) {
  this->input_channels = input_channels, this->output_channels = output_channels,
  this->kernel_h = kernel_h, this->kernel_w = kernel_w;
...
void FCDescriptor::initializeValues(int input_channels, int output_channels,
                                    ActivationMode activation_mode, double actv_coef) {
...
void ActivationDescriptor::initializeValues(ActivationMode mode, int channels, int h, int w,
                                            double coef) {
  this->mode = mode;
...
void SoftmaxDescriptor::initializeValues(SoftmaxAlgorithm algo, SoftmaxMode mode, int channels,
                                         int h, int w) {
  this->algo = algo;
  this->mode = mode;
  this->channels = channels;
...
void LayerSpecifier::freePointer() { free(params); }
